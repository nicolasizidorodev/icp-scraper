...
const META: Record<string, { label: string; hint: string }> = {
  ...
  META_AD_LIBRARY_TOKEN: { label: "Meta Ad Library", hint: "Confirma anúncios ativos (opcional)" },
  ANTHROPIC_API_KEY: { label: "Anthropic (Claude)", hint: "Relatórios, copy, LP, design" },
